...
<div class="absolute top-0 left-0 w-full overflow-hidden leading-[0] z-[-999]">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex items-center justify-center w-full h-40 border-2 border-dashed border-gray-300 rounded-lg mt-2">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <span class="mt-4 text-lg text-gray-500">Unggah atau ambil foto di sini</span>
                        </div>
                    </div>
    ...
    <script>
        var map = L.map('mapid').setView([51.505, -0.09], 13); // Set initial map view

        L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
        }).addTo(map);

        // Add click event to place a marker (pin)
        map.on('click', function(e) {
            var latlng = e.latlng;
            var marker = L.marker(latlng).addTo(map);
            marker.bindPopup("<b>TPS Ilegal</b><br>" + latlng.toString()).openPopup();
        });
    </script>
