<section id="beranda" class="custom-gradient relative text-white overflow-hidden">
  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-32 flex flex-col lg:flex-row items-center justify-between gap-10 overflow-hidden">
    <!-- Konten Kiri -->
    ...
    <!-- Gambar Kanan -->
    <div class="w-full lg:w-1/2 flex justify-center lg:justify-end relative h-[90vh] overflow-hidden">
      <img src="{{ asset('img/asethero.png') }}" alt="Maskot CerdasSampah" class="w-full h-full object-contain z-10 animate-float">
    </div>
  </div>

  <!-- Wave Animasi -->
  <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] pointer-events-none z-10">
    <div class="relative w-full h-[500px] md:h-[700px] lg:h-[800px]">
      <!-- Wave 1 -->
      ...
      <!-- Wave 3 -->
      <svg class="absolute bottom-0 w-full h-[300px] animate-wave-3 delay-500 opacity-50" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none">
