<header id="main-header" class="fixed top-0 left-0 w-full z-50 transition-all duration-300 bg-transparent">
  <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between h-16">
      ...
      <img src="/img/lbs.png" alt="Logo" class="h-8 w-8" />
      <img src="/img/tbs.png" alt="Logo" class="h-48 w-auto" />
      </div>
      ...
      <nav id="main-nav"
           class="hidden lg:flex flex-row items-center space-x-4 text-sm font-semibold text-white">
        ...
        <a href="#masuk" class="px-4 py-2 rounded-md hover:bg-green-700 transition">Masuk</a>
      </nav>
    </div>

<!-- Mobile Nav Menu -->
<div id="mobile-nav" class="lg:hidden overflow-hidden max-h-0 transition-all duration-500 ease-in-out bg-white rounded-md p-0 text-gray-800">
  <a href="#beranda" class="block px-4 py-2 hover:bg-green-100 rounded">Beranda</a>

  <div class="border-t border-gray-200"></div>

  <!-- Fitur Toggle -->
  <button id="fitur-toggle" class="w-full text-left px-4 py-2 font-semibold hover:bg-green-100 flex justify-between items-center">
    <span>Fitur</span>
    <svg id="fitur-icon" class="h-4 w-4 transition-transform duration-200" fill="currentColor" viewBox="0 0 20 20">
      <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.293l3.71-4.06a.75.75 0 111.1 1.02l-4.25 4.65a.75.75 0 01-1.1 0L5.25 8.27a.75.75 0 01-.02-1.06z" clip-rule="evenodd" />
    </svg>
  </button>
  ...
  <a href="#masuk" class="block px-4 py-2 hover:bg-green-100 rounded">Masuk</a>
</div>
  </div>
</header>
