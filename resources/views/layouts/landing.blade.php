...
<head>
  ...
  <title>@yield('title', 'CerdasSampah')</title>
  ...
  <style>
    ...
    .swal2-confirm {
        ...
        box-shadow: none !important; /* Menghapus semua shadow */
    ...
    .swal2-confirm {
        background-color: #4CAF50 !important; /* Warna hijau tombol */
    ...
    .swal2-confirm:hover {
        background-color: #45a049 !important; /* Warna hijau lebih gelap saat hover */
    }
