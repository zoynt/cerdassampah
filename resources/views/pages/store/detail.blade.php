    ...
    <div class="container mx-auto px-4 py-8 space-y-6">
        <div class="space-y-6 md:space-y-8" x-data="productPage()">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-xl md:text-2xl font-bold text-white">Detail Produk</h1>
            </div>
                    ...
                    <div>
                        ...
                        <template x-if="isDescriptionOverflowing">
                            <button @click="isDescriptionModalOpen = true"
                                class="mt-2 text-sm font-bold text-green-700 hover:text-green-600">Baca
                                Selengkapnya</button>
                        </template>
                    </div>
                </div>
                        ...
                        <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
                            <div>
                                ...
                                <div class="flex items-center border border-gray-300 rounded-lg w-32 flex-shrink-0">
                                    ...
                                    <input type="text" :value="formattedQuantity()"
                            ...
                            <div class="w-full md:w-auto flex flex-col sm:flex-row md:flex-col gap-2 flex-shrink-0">
                                <form
                                    ...
                                    <button type="submit"
                                        class="w-full md:w-48 text-center px-4 py-3 bg-green-700 text-white font-semibold rounded-lg shadow-md hover:bg-green-600">
                                        {{-- Teks dinamis: jika login tampil "Beli", jika tidak "Login" --}}
                                        @auth
                                            Beli Langsung
                                        @else
                                            Login untuk Membeli
