    ...
    <div class="p-4 sm:p-6 lg:p-8 -mt-16 relative z-10 ">
        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            @endforelse
                ...
                <div class="mt-6 bg-amber-400 p-6 rounded-2xl shadow-lg">
        ...
        <div class="mt-6">
            <div class="relative bg-green-200 p-6 lg:p-8 rounded-2xl shadow-lg flex flex-col lg:flex-row items-center overflow-hidden">
                {{-- Elemen Latar Belakang - SVG Pertama (lebih besar, di kanan bawah) --}}
                <div class="absolute -bottom-1/2 -right-20 z-0 opacity-25">
                    <svg class="w-96 h-100 text-green-400" xmlns="http://www.w3.org/2000/svg" width="400" height="461" viewBox="0 0 400 461" fill="none">
                        <path d="M181.25 0C175.107 1.37772 169.131 3.41431 163.425 6.07439C63.825 52.6197 0 182.782 0 294.295C0 400.285 79.575 487.376 181.25 497V0ZM218.75 497C320.425 487.376 400 400.31 400 294.32C400 284.155 399.475 273.872 398.425 263.474L218.75 443.155V497ZM356.5 127.412C346.908 109.43 335.695 92.3612 323 76.4173L218.75 180.657V265.148L356.5 127.412ZM297.7 48.6701C279.776 31.2442 259.13 16.8569 236.575 6.07439C230.869 3.41431 224.893 1.37772 218.75 0V127.637L297.7 48.6701ZM373.4 163.509L218.75 318.168V390.111L387.5 221.378L390.8 218.078C386.4 199.471 380.583 181.228 373.4 163.509Z" fill="currentColor"/>
                    </svg>
                </div>

                {{-- Elemen Latar Belakang - SVG Kedua (lebih kecil, di kiri atas) --}}
                <div class="absolute -top-1/4 -left-10 z-0 opacity-25 transform rotate-180">
                     <svg class="w-48 h-48 text-green-400" xmlns="http://www.w3.org/2000/svg" width="400" height="461" viewBox="0 0 400 461" fill="none">
                        <path d="M181.25 0C175.107 1.37772 169.131 3.41431 163.425 6.07439C63.825 52.6197 0 182.782 0 294.295C0 400.285 79.575 487.376 181.25 497V0ZM218.75 497C320.425 487.376 400 400.31 400 294.32C400 284.155 399.475 273.872 398.425 263.474L218.75 443.155V497ZM356.5 127.412C346.908 109.43 335.695 92.3612 323 76.4173L218.75 180.657V265.148L356.5 127.412ZM297.7 48.6701C279.776 31.2442 259.13 16.8569 236.575 6.07439C230.869 3.41431 224.893 1.37772 218.75 0V127.637L297.7 48.6701ZM373.4 163.509L218.75 318.168V390.111L387.5 221.378L390.8 218.078C386.4 199.471 380.583 181.228 373.4 163.509Z" fill="currentColor"/>
                    </svg>
                </div>

                {{-- Wrapper Konten --}}
                <div class="relative z-10 flex flex-col lg:flex-row items-center w-full gap-8">
                    {{-- Kolom Kiri: Teks --}}
                    {{-- Menambahkan order-last untuk mobile/tablet, agar teks muncul setelah ikon --}}
                    <div class="lg:w-3/4 text-center lg:text-left order-last lg:order-first">
                        <span class="inline-block bg-green-600 text-white px-4 py-1.5 rounded-lg text-2xl font-semibold">
                            Mau Daur Ulang ?
                        </span>
                        <h2 class="mt-3 text-3xl lg:text-4xl font-bold text-green-900">
                            Yuk, ubah sampah jadi cuan di Cerdassampah!
                        </h2>
                        <p class="mt-3 text-green-800/90 max-w-lg">
                            Ubah sampah terpilahmu jadi peluang! Jual kardus, botol plastik, hingga minyak jelantah langsung ke pengepul atau UMKM daur ulang.
                        </p>
                        <a href="#" class="inline-block mt-6 px-8 py-3 bg-white text-green-700 font-semibold rounded-lg shadow-md hover:bg-green-50 transition">
                            Jelajahi Marketplace!
                        </a>
                    </div>

                    {{-- Kolom Kanan: Ikon --}}
                    {{-- Menambahkan order-first untuk mobile/tablet, agar ikon muncul paling awal --}}
                    <div class="lg:w-1/4 flex justify-center mt-8 lg:mt-0 order-first lg:order-last">
                        <div class="bg-white rounded-full p-6 shadow-lg w-32 h-32 lg:w-40 lg:h-40 flex items-center justify-center">
                            <svg class="w-20 h-20 lg:w-24 lg:h-24 text-green-600" xmlns="http://www.w3.org/2000/svg" width="177" height="126" viewBox="0 0 177 126" fill="none">
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M88.0923 27.7839C71.8298 11.5089 51.5048 4.69642 35.6173 1.90892C29.0124 0.740007 22.3241 0.104623 15.6173 0.00891737C13.0825 -0.024936 10.5473 0.0376075 8.01727 0.196416L7.55476 0.233916H7.42976L7.37977 0.246418H7.35476L2.60476 0.696418L1.79226 5.39642L1.77976 5.45892L1.75476 5.60892L1.65476 6.17142L1.36726 8.20892C0.017734 18.7062 -0.333838 29.3078 0.317264 39.8714C1.54226 58.7589 6.66726 82.7964 23.3673 99.4964C39.6923 115.821 59.5923 122.184 75.1173 124.509C81.8383 125.517 88.637 125.915 95.4298 125.696V115.321L47.2673 67.1339L56.1173 58.2839L95.4423 97.6339V36.7964C93.2923 33.5464 90.8423 30.5339 88.0923 27.7839ZM107.942 53.9714V99.7214L129.042 82.8464L136.842 92.5964L107.942 115.721V125.571C112.513 125.626 117.082 125.367 121.617 124.796C132.98 123.334 147.742 119.271 158.717 108.296C169.792 97.2089 174.055 80.4714 175.742 67.5589C176.736 59.7761 177.063 51.9224 176.717 44.0839L176.692 43.6839V43.5589L176.68 43.5339L176.305 38.4964L171.33 37.7839H171.28L171.167 37.7589L170.792 37.7089L169.405 37.5464C162.419 36.8394 155.385 36.7224 148.38 37.1964C136.167 38.0964 120.067 41.3339 109.692 52.1464L109.192 52.6464L107.942 53.9714Z" fill="#5E936C"/>
                            </svg>
                        </div>
                    </div>
                </div>
