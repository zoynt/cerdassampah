<section id="beranda" class="custom-gradient relative text-white overflow-hidden">
    ...
    <div class="absolute top-0 left-0 w-full h-full z-0 pointer-events-none overflow-hidden max-w-screen">
        <div class="absolute top-10 left-[5%] md:left-10 w-40 h-40 bg-white/10 rounded-full blur-3xl animate-pulse">
        </div>
        <div class="absolute bottom-20 right-[5%] md:right-10 w-32 h-32 bg-white/10 rounded-full blur-2xl animate-ping">
        </div>
    </div>

    <div
        class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-32 flex flex-col-reverse lg:flex-row items-center justify-between gap-10 overflow-hidden">
        <!-- Konten Kiri -->
        ...
        <div class="w-full lg:w-1/2 flex justify-center" data-aos="fade-left">
            <img src="{{ asset('img/logobiasa.png') }}" alt="Maskot CerdasSampah"
                class="w-[300px] md:w-[360px] lg:w-[400px] animate-float">
        </div>
    </div>
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] pointer-events-none z-0">
        <div class="relative w-full h-[200px] md:h-[250px] lg:h-[280px]">
            <!-- Wave 1 -->
            <svg class="absolute bottom-0 w-full h-full animate-wave-1" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 1440 320" preserveAspectRatio="none">
                <path fill="#e6fff5" fill-opacity="1"
                    d="M0,256L80,250.7C160,245,320,235,480,229.3C640,224,800,224,960,229.3C1120,235,1280,245,1360,250.7L1440,256L1440,320L0,320Z" />
            </svg>
            <!-- Wave 2 -->
            <svg class="absolute bottom-0 w-full h-full animate-wave-2 delay-300 opacity-70"
            ...
            <!-- Wave 3 -->
            <svg class="absolute bottom-0 w-full h-full animate-wave-3 delay-500 opacity-50"
                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" preserveAspectRatio="none">
                <path fill="#ffffff" fill-opacity="1"
                    d="M0,240L80,218.7C160,197,320,155,480,149.3C640,144,800,176,960,202.7C1120,229,1280,251,1360,261.3L1440,272L1440,320L0,320Z" />
            </svg>
        </div>
    </div>
</section>
