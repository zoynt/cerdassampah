  ...
  <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-32 flex flex-col-reverse lg:flex-row items-center justify-between gap-10 overflow-hidden">
    ...
    <div class="w-full lg:w-1/2 text-center lg:text-left" data-aos="fade-right">
      ...
      <p class="text-sm sm:text-base md:text-lg mb-8 text-white/90">
        BapilahSampah.id adalah aplikasi website berbasis Smart Environment yang mendukung pilar Smart City melalui pengelolaan sampah yang inovatif dan partisipatif. Dirancang untuk meningkatkan kesadaran serta keterlibatan masyarakat.
      </p>
      <a href="informasi" class="inline-block bg-white text-green-700 font-semibold px-6 py-3 rounded-md shadow hover:bg-green-100 transition duration-300">
    ...
    <div class="w-full lg:w-1/2 flex justify-center" data-aos="fade-left">
      <img src="{{ asset('img/asethero.png') }}" alt="Maskot CerdasSampah" class="w-[300px] md:w-[360px] lg:w-[400px] animate-float">
    </div>
  </div>
