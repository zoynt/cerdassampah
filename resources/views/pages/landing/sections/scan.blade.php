    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start mb-12 pb-6">
            <div class="lg:col-span-1 text-gray-800 mt-6 lg:mt-0 " data-aos="fade-right">
                ...
                <p class="text-gray-600 mt-0 mb-8 text-lg md:text-xl leading-normal">
                    Kenali jenis sampah hanya dengan satu kali pindai. Fitur Scan Sampah memanfaatkan teknologi machine
                    learning untuk mengidentifikasi sampah organik, anorganik, dan berbahaya (B3) secara otomatis dan
                    akurat.
                </p>
                <a href="{{ route('scan.form') }}"
                    class="inline-block bg-green-700 text-white font-semibold px-6 py-3 rounded-md shadow hover:bg-green-800 transition duration-300">
                    Pindai Sekarang!
                </a>
            </div>
            ...
            <div class="flex justify-center relative mx-auto scan-icon" data-aos="zoom-in">
                ...
                <!-- Ikon di tengah -->
                <svg xmlns="http://www.w3.org/2000/svg" class="text-green-700 z-10" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="1.5" id="scan-icon">
        ...
        <div class="mt-16 bg-green-50 p-8 rounded-xl relative z-10" data-aos="zoom-in">
            ...
            <p class="text-center text-gray-700 max-w-2xl mx-auto mb-12">
                Unggah foto sampah, dalam tiga langkah sederhana, Anda dapat mengetahui apakah sampah tersebut tergolong
                organik, anorganik, atau berbahaya.
            </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                ...
                <div data-aos="zoom-in" data-aos-delay="0">
                    <div
                        class="w-12 h-12 mx-auto bg-green-600 text-white flex items-center justify-center rounded-full text-lg font-bold mb-4">
                        1</div>
