...
<section id="edukasi" class="relative z-10 pb-12 bg-blue-400">
  <div class="max-w-7xl mx-auto px-4">
    <div class="grid grid-cols-1 lg:grid-cols-1">
      
      <h2 class="text-xl font-bold text-blue-900 tracking-wide mb-8 border-b-2 border-blue-700 w-fit z-[1]" data-aos="fade-down">
        Video Edukasi
      </h2>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-1 items-start text-center" data-aos="fade-up">
      <div class="lg:col-span-1 text-white mt-6 lg:mt-0">
        <h3 class="text-xl md:text-3xl font-semibold leading-tight mt-2 mb-4">
          Edukasi Interaktif Smart City
        </h3>
        <p class="text-white/90 mt-0 mb-8 text-md md:text-xl leading-normal max-w-4xl mx-auto">
          Pelajari berbagai aspek Smart City melalui video-video interaktif dan informatif. Mulai dari pengelolaan sampah, transportasi cerdas, layanan publik digital, hingga inovasi energi dan partisipasi masyarakat.
        </p>
      </div>
    </div>
  </div>
