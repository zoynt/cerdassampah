                        ...
                        <div class="relative">
                            <select id="kecamatan" name="kecamatan"
                                ...
                                @foreach ($kecamatans as $data)
                                    {{-- Menggunakan kolom 'district' yang baru --}}
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-600">
                    ...
                    <tbody id="bank-table-body">
                        {{-- Memuat partial view untuk isi tabel --}}
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateMapAndTableInteractivity(locations) {
                ...
                (locations || []).forEach(loc => {
                    ...
                    // [PERBAIKAN] Menggunakan rute baru dari Controller
                    const detailUrl = `/bank-sampah/profil/${loc.slug}`; // Rute ke profil
                    const setorUrl = `/bank-sampah/item/${loc.slug}`; // Rute ke item
                        ...
                        <div class="w-64 rounded-lg overflow-hidden shadow-lg bg-white p-0">
                            ...
                            <div class="p-3">
                                ...
                                <div class="mt-4 grid grid-cols-2 gap-2">
                                    <a href="${detailUrl}" class="block text-center w-full px-4 py-2 bg-white text-green-700 text-sm font-semibold rounded-lg border border-green-200 hover:bg-green-50 ...">
                                        Detail Bank
                                    </a>
                                    <a href="${setorUrl}" class="button-link block text-center w-full px-4 py-2 bg-green-700 text-white text-sm font-semibold rounded-lg hover:bg-green-600 ...">
                                        Lihat Item
                                    </a>
                                </div>
                            </div>
            ...
            function handleFilterChange() {
                ...
                document.getElementById('bank-table-body').innerHTML = `<tr><td colspan="6" class="text-center p-6 animate-pulse">Memuat data...</td></tr>`;
                ...
                fetch(url, { headers: { 'X-Requested-With': 'XMLHttpRequest' } })
                    ...
                    .catch(error => {
                        ...
                        document.getElementById('bank-table-body').innerHTML = `<tr><td colspan="6" class="text-center p-6 text-red-500">Gagal memuat data.</td></tr>`;
                    });
            }
