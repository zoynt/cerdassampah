        ...
        <div class="space-y-6">
            <div class="swiper mySwiper w-full overflow-hidden rounded-xl shadow-md relative z-0">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="{{ route('mystore.dashboard') }}">
                            <img src="{{ asset('img/iklan2.jpg') }}" alt="Iklan 2" class="w-full h-full object-cover">
                        </a>
                    </div>
                </div>
                            ...
                            <div
                                ...
                                <div class="p-3 md:p-4 flex flex-col flex-grow w-1/2 md:w-full">
                                    ...
                                    <p class="text-xs text-gray-500 flex items-center">
                                        {{-- <svg class="w-4 h-4 mr-1 text-gray-400" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0zM15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                        </svg> --}}
                                        <span
                                            x-text="product.distance ? `${product.distance} Km` : 'Menghitung...'"></span>
                                    </p>
            ...
            return {
                ...
                getUserLocation() {
                    if (navigator.geolocation) {
                        navigator.geolocation.getCurrentPosition(position => {
                            ...
                            // Gagal mendapatkan lokasi, set jarak ke null
                            this.products.forEach(p => p.distance = null);
                        });
                    } else {
                ...
                calculateDistances() {
                    ...
                    this.products.forEach(product => {
                        if (product.store_lat && product.store_lng) {
