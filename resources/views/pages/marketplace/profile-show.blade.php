            ...
            <div class="p-6 space-y-6">
                <div class="flex items-center gap-4">
                    ...
                    <span @class([
                        ...
                        'bg-red-100 text-red-800' => !$store->is_active,
                    ])>
                ...
                <div class="border-t pt-6">
                    ...
                    <p class="text-gray-800 mt-1 prose prose-sm max-w-none">{{ $store->description }}</p>
                </div>
            </div>
        </div>
    </div>
