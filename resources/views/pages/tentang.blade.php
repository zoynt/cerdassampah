...
@section('content')
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-20 lg:py-32 flex flex-col-reverse lg:flex-row items-center justify-between gap-10 overflow-hidden" style="padding-bottom: 48px;">
      ...
      <div class="w-full text-center">
        ...
        <div class="flex flex-col items-center md:items-start sm:items-start">
          <h3 class="text-xl text-white bg-green-600 font-semibold mb-4 p-4 inline-block rounded-xl text-center md:text-left sm:text-left">BapilahSampah</h3>
          <p class="text-lg" style="text-align: justify;">BapilahSampah adalah platform digital yang dirancang untuk membantu masyarakat mengelola sampah dengan cara yang lebih cerdas, praktis, dan interaktif. Melalui berbagai fitur unggulan seperti pemindaian sampah, pemetaan lokasi TPS beserta jadwal pengangkutannya, game pilah sampah, hingga pelaporan TPS ilegal, BapilahSampah hadir untuk menghubungkan edukasi, teknologi, dan aksi nyata di lapangan.</p>
        </div>
        </div>
      </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12" style="padding-bottom: 64px; padding-top: 0px;">
