...
// Route::post('/scan-sampah', [ScanController::class, 'scan'])->name('lapor.scan');
// Route::post('/scan-sampah', [ScanController::class, 'scan'])->name('scan.process');

// Route::get('/laporan', function () {
//     return view('landing/laporan-tps');
// });
